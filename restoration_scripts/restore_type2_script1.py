...
DEFAULT_RESTORATION_SUBDIR = "restore_type2_script1"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional output folder. Default: restorations/restore_type2_script1_auto",
    )
...
def split_fracture_class(class_mask, fracture_arr):
    ...
    - keep main component (label 1) as one fragment
    - split label 2 into connected components
    """
    ...
    main_mask = fracture_inside == 1
    small_mask = fracture_inside == 2
    ...
    if np.any(small_mask):
        cc, n = ndimage.label(small_mask, structure=ndimage.generate_binary_structure(3, 3))
